                ...
                <div className="px-6 sm:px-8 py-3 sm:py-4 flex flex-col gap-1 sm:gap-2 overflow-y-auto max-h-[95vh]">
                    ...
                    <div className="flex items-center justify-between mb-1">
                        ...
                        <span className="font-display text-xl sm:text-2xl font-extrabold text-white tracking-tight">
                            {mode === 'signup' ? 'Registrieren' : mode === 'forgot' ? 'Zurücksetzen' : 'Einloggen'}
                        </span>
                    </div>
                                            ...
                                            <div className="flex justify-between gap-1.5 my-1">
                                                {otpCode.map((digit, idx) => (
                                                    <input
                                                        ...
                                                        className="w-11 h-12 text-center text-lg font-mono font-bold bg-white/20 border border-white/50 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-gold/70 transition-all"
                                                        placeholder="•"
                                                    />
                                                ))}
                                            </div>
                                        ...
                                        <div className="flex justify-between items-center text-[10px] pt-1">
                                            ...
                                            <button
                                                ...
                                                onClick={() => {
                                                    setOtpCode(['', '', '', '', '', '']);
                                                    setOtpError('');
                                                    alert(`Neuer Code an ${forgotEmail} gesendet!`);
                                                }}
                                                className="text-gold/80 hover:text-gold font-semibold transition-colors"
                                            >
                                                Code erneut senden
                                            </button>
                                        </div>
