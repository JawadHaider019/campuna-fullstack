                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 items-start">
                    ...
                    <div className="space-y-4 min-w-[150px] h-auto">
                        ...
                        <ul className="space-y-3 font-sans text-[14px] text-charcoal/80">
                            <li>
                                <Link href="/" className="hover:text-forest transition-colors font-[400]">
                                    Startseite
                                </Link>
                            </li>
                            <li>
                    ...
                    <div className="space-y-4 min-w-[150px]">
                        ...
                        <ul className="space-y-3 font-sans text-[14px] text-charcoal/80">
                            <li>
                                <Link href="/agb" className="hover:text-forest transition-colors font-[400]">
                                    AGB
                                </Link>
                            </li>
                            <li>
                                <Link href="/nutzungsbedingungen" className="hover:text-forest transition-colors font-[400]">
                                    Nutzungsbedingungen
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link href="/impressum" className="hover:text-forest transition-colors font-[400]">
                                    Impressum
                                </Link>
                            </li>
                        </ul>
